...
#ifndef MT6575_BATTERY_H
#define MT6575_BATTERY_H
...
#define charger_OVER_VOL	    0x01	/*bit0 set*/
#define BATTERY_UNDER_VOL		2
#define BATTERY_OVER_TEMP		0x04	/*bit2 set*/
#define BATTERY_LOW_TEMP        0x02           /*bit1 set*/
