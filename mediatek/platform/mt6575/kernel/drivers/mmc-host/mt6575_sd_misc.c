...
{
	struct msdc_host *host = msdc_6575_host[1];
...
int simple_mt6575_sd_ioctl_multi_rw(struct msdc_ioctl* msdc_ctl)
{
	char l_buf[512];
	struct scatterlist msdc_sg;
	struct mmc_data  msdc_data;
...
EXPORT_SYMBOL(simple_mt6575_sd_ioctl_multi_rw);
