...
#define EN_CUSTOM_EXIF_INFO //PR272677 modify by xianfeng.xu
MINT32 custom_SetExif(void **ppCustomExifTag)
{
#ifdef EN_CUSTOM_EXIF_INFO
#define CUSTOM_EXIF_STRING_MAKE  "TCL" //PR272677 modify by xianfeng.xu
#define CUSTOM_EXIF_STRING_MODEL "E928" //PR272677 modify by xianfeng.xu
