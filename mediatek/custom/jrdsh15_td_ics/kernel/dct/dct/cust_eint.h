...
#define CUST_EINT_AST_RFCONFLICT_INTR_NUM              0
#define CUST_EINT_AST_RFCONFLICT_INTR_DEBOUNCE_CN      0
#define CUST_EINT_AST_RFCONFLICT_INTR_POLARITY         CUST_EINT_POLARITY_HIGH
#define CUST_EINT_AST_RFCONFLICT_INTR_SENSITIVE        CUST_EINT_LEVEL_SENSITIVE
#define CUST_EINT_AST_RFCONFLICT_INTR_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define CUST_EINT_AST_WAKEUP_INTR_NUM              1
#define CUST_EINT_AST_WAKEUP_INTR_DEBOUNCE_CN      0
#define CUST_EINT_AST_WAKEUP_INTR_POLARITY         CUST_EINT_POLARITY_HIGH
#define CUST_EINT_AST_WAKEUP_INTR_SENSITIVE        CUST_EINT_EDGE_SENSITIVE
#define CUST_EINT_AST_WAKEUP_INTR_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
...
#define CUST_EINT_COMBO_BGF_NUM              5
...
#define CUST_EINT_AST_DATA_INTR_NUM              7
#define CUST_EINT_AST_DATA_INTR_DEBOUNCE_CN      0
#define CUST_EINT_AST_DATA_INTR_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_AST_DATA_INTR_SENSITIVE        CUST_EINT_LEVEL_SENSITIVE
#define CUST_EINT_AST_DATA_INTR_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
...
#define CUST_EINT_CMMB_NUM              13
#define CUST_EINT_CMMB_DEBOUNCE_CN      0
#define CUST_EINT_CMMB_POLARITY         CUST_EINT_POLARITY_HIGH
#define CUST_EINT_CMMB_SENSITIVE        CUST_EINT_EDGE_SENSITIVE
#define CUST_EINT_CMMB_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
