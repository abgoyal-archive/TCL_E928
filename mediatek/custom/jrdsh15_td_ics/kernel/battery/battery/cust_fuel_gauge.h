...
#define MAX_BOOTING_TIME_FGCURRENT	1*10 // 5 seconds, 6 points = 1s
...
#define R_FG_VALUE 				20 // mOhm, base is 20/ modify to 24 as JRD GIN PCB design can't meet our requirement
#define CURRENT_DETECT_R_FG	100  //10mA

#define OSR_SELECT_7			0

#define CAR_TUNE_VALUE			87 //0.94  modify by sangmei
