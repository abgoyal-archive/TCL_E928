        ...
        if (doTextWrap && hasTextToWrap) {
            ...
            if (!isConstrained) {
                ...
                if (node) {
                    ...
                    String specialUrl3 = "http://218.206.177.209:8080/waptest/browser15/css/brw-css-02.html";
                    if (textWrapWidth < 500) {
                        if (equalIgnoringCase(url, specialUrl1) || 
                            equalIgnoringCase(url, specialUrl2) ||
                            equalIgnoringCase(url, specialUrl3)) {
                            textWrapWidth = 500;
                        }
                    }
                }
